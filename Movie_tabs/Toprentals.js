...
export default class Toprentals extends Component {
      constructor(props){
            super(props);
            this.state ={
              isLoading: true,
    ...
    async componentDidMount()
    {
          ...
          return fetch('https://api.themoviedb.org/3/movie/now_playing?api_key=ca7d5b4e1ef2579d75ffd62fd445e6ea&language=en-US&page=10')
