...
export default class Nowplaying extends Component {
      ...
      componentDidMount(){
  return fetch('https://api.themoviedb.org/3/movie/top_rated?api_key=ca7d5b4e1ef2579d75ffd62fd445e6ea&language=en-US&page=1')
      ...
      renderItem={({item}) =>
            <View style={{height:height*0.33,width:width*0.3,marginTop:width*0.025,marginLeft:width*0.026,backgroundColor:'lightgray',flexDirection:'column'}}>
              ...
              <View style={{flex:0.2,flexDirection:"row"}}>
                ...
                <View style={{flex:0.1}}>
                  <Icon name='ellipsis-v' style={{color:'black', fontSize:17,marginTop:height*0.007}}/>
                </View>
              </View>
            </View>
        }
