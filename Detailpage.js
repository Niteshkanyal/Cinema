      ...
      <View style={{flex:1,flexDirection:'column'}}>
        <View style={{flex:0.55,flexDirection:'column',position:'relative'}}>
            ...
            <Modal
              ...
              <Image indicator={ActivityIndicator} source={{ uri: imgPath + this.state.head.backdrop_path }} style={{ width:width, height:height*0.38,position:'relative'}} />
                ...
                <Icon name='share-alt' style={{color:'white', fontSize:20,marginTop:height*0.014,marginLeft:width*0.824,position:'absolute'}} onPress={this.onOpen.bind(this)}/>
          ...
          <View style={{flex:2}}>
              <ScrollableTabView
                ...
                renderTabBar={() => <ScrollableTabBar />}>
                     ...
                     <Cast_detail tabLabel='CAST' dataSource={this.state.dataSource}  head={this.state.head}/>
